...
import com.r462.hammad.questionnaire.PlacesAutoCompleteAdapter;

/**
 * Created by Muhammad Masood on 17/12/2017.
 */
...
public class PlacesAutoCompleteAdapter
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    Log.i("Filters", (String) constraint);
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            Log.i("HEL", "Starting autocomplete query for: " + constraint);
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
       ...
       /* mPredictionHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectedPosition=i;
                mResultList.remove(selectedPosition);
