        ...
        nextWeaponBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // for(int i=0;i<selectweaponList.size();i++){
                ...
                //}
                sharedPreferences.setCriminalWeapon(getActivity(),selectweaponList);

                getFragmentManager().beginTransaction().replace(R.id.fragment_container,new criminalFacialFeature()).addToBackStack(null).addToBackStack(null).commit();
            }
        });
